...
<div class="headers_container1">
	<div class="headers_container1_box">
		<div class="header1">
			<a href="homepage.jsp"><img src="image/Ro.png" width="100%" height="100%"></a>
		</div>
		<div class="header2" align="center">
			<div class="search">
				<form action="search_recipes3.jsp" method="get" Style="height:100%">
					<input type="hidden" name="before" value="headers">
					<input id="search_in" type="text" name="text" placeholder="검색어 입력">
		...
		<div class="header3">
			<div class="login">
				...
				%>
				<a class=login href=login/login.jsp Style="color: black">로그인</a>
				<%
				}
				else{
				%>
				<span Style="color: black"><%=session.getAttribute("id") %></span>
				<a href="jsp/logout.jsp" Style="color: black">로그아웃</a>
				<%
				}
				%>
			</div>
...
<div class="headers_container2">
  ...
  <ul id="main-menu">
    ...
    <li><a href="change_inform.jsp">정보수정</a>
       <ul id="sub-menu">
